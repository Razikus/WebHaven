        ...
        <div class="bg-white rounded-lg shadow">
            <div class="px-4 py-5 sm:p-6">
                ...
                <div class="mt-4 space-y-4">
                    <div v-for="session in sessions" :key="session" class="border rounded-lg p-4">
                        ...
                        <div v-if="statePerSession[session]" class="mt-4">
                            ...
                            <div class="space-y-4">
                                <div v-for="channel in statePerSession[session].chatChannels" :key="channel">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <input v-model="chatMessage" :placeholder="`Message ${channel}`"
...
const { sendMessage, sessions, messagesPerSessionPerChannel, statePerSession } = inject('websocket');
