...
public class AuthClient implements Closeable {
	...
	String crt = "-----BEGIN CERTIFICATE-----\n" +
			"MIIDdjCCAl6gAwIBAgIBMzANBgkqhkiG9w0BAQsFADBkMQswCQYDVQQGEwJTRTES\n" +
			"MBAGA1UEBwwJU3RvY2tob2xtMRIwEAYDVQQKDAlEb2xkYTIwMDAxFTATBgNVBAsM\n" +
			"DERvbGRhMjAwMCBDQTEWMBQGA1UEAwwNZG9sZGEyMDAwLmNvbTAeFw0yMDA5MTgy\n" +
			"MDE5MTVaFw0yMjA5MTgyMDE5MTVaMHcxCzAJBgNVBAYTAlNFMREwDwYDVQQKDAhT\n" +
			"ZWF0cmliZTEvMC0GA1UEAwwmSGF2ZW4gQXV0aGVudGljYXRpb24gSXNzdWluZyBB\n" +
			"dXRob3JpdHkxJDAiBgkqhkiG9w0BCQEWFWZyZWRyaWtAZG9sZGEyMDAwLmNvbTCC\n" +
			"ASIwDQYJKoZIhvcNAQEBBQADggEPADCCAQoCggEBAMgzHaY+rKrDXR+HTAGz5GER\n" +
			"/ykt4rMvFLvD+9vBt6o3rn+xbSOV5GMIFpMc3VGj6Od8oBaYZxVZFq+u9Ml6RtRf\n" +
			"+Iq1N/7NeYBAl9YLNcEWk+K05MnRat0zV/3dS8RwuiKSlVxfaBdta7hibXnB4mxp\n" +
			"7OHAhmQGYKlJO8R3gDle+rtEZEmE8YJnJRmMilgtCpr0Bfvl3WBTywjSHjP8ny2g\n" +
			"dV4Tt5o/a59Yt0pNtPTS3m4IQBaXKPhJkot7oIoI1Uq8wVBDRVZCZXpqn3o5G8T5\n" +
			"TVrwQHozUd7YtvDCG1w8OizJEMIU2mKnXilyA2/n/iME0u+AS/7y2jvgOLxEcjEC\n" +
			"AwEAAaMgMB4wDwYDVR0TAQH/BAUwAwEB/zALBgNVHQ8EBAMCAQYwDQYJKoZIhvcN\n" +
			"AQELBQADggEBAGRTytRN97v4QVi1Pqj3UHfBd1S3TkJ5c4cwIJY8ry2rTGcZS+RX\n" +
			"St8kRQ4VQwt5tFCRfgk6UCSi6LFK0wUvngGpgRr9nJeuZR4kBOaXDfvxyMPNkLae\n" +
			"Ufgd/ta5g6h3hUjlRgslCPE+c0yaoDujIu7nOtEfntfG36rs4DAzwOHQR1g2dnb2\n" +
			"lfDwxfLHNRpljwEdCgrl6Du5iYe6TNfpTwZBimUvI7arBWP+Lk5p7J4xwGAc3EAc\n" +
			"vs8C2JsjvJ8Dw3tL8PlNPTYNSjouX1GD/rbxurHZvZdK+fncavhLE3bUMjQ118Wl\n" +
			"PS0gUSBSxq29klLHdPDaHy5vI6voWY+Xxt4=\n" +
			"-----END CERTIFICATE-----\n";

	InputStream is = new ByteArrayInputStream(crt.getBytes(StandardCharsets.UTF_8));
	try {
	    ssl.trust(is);
	} catch(Exception e) {
